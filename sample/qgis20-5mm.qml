...
<qgis version="2.0.1-Dufour" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="A_CNTR"/>
    <edittype labelontop="0" editable="1" type="0" name="A_DSTRCT"/>
    <edittype labelontop="0" editable="1" type="0" name="A_PSTCD"/>
    <edittype labelontop="0" editable="1" type="0" name="A_RGN"/>
    <edittype labelontop="0" editable="1" type="0" name="NAME"/>
    <edittype labelontop="0" editable="1" type="0" name="NAME_EN"/>
    <edittype labelontop="0" editable="1" type="0" name="NAME_RU"/>
